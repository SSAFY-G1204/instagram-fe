  ...
  return (
    <div>
      <div className="newPosterContainer">
          ...
          {!isShowNewPoster ? (
            ...
            <div className="newPosterMain2Container">
              <div className="newPosterMain2TopContainer">
                <BsArrowLeft className="leftArrowIcon" onClick={showPrevPage} />
              ...
              <div className="newPosterMain2ContentsContainer">
                <div className="leftSideContainer">
                  <img className="newPosterImage" alt="사진" src={imageFile} />
                  {newPosterStatus === "cut" ? (
                          ...
                          {editGbnValue.map((value) => (
                            <div
                              className={`editGbnValue ${
                                value.id === selectedFilterTab ? "active" : ""
                              }`}
                          ...
                          {showAccess ? (
                            <div>
                              ...
                              <p className="replaceText">
                                ...
                                사람들에게 사진 내용을 설명하는 텍스트입니다.
                                대체 텍스트는 회원님의 사진에 대해 자동으로
                                생성되며, 직접 입력할 수도 있습니다.
                              </p>
                          ...
                          {showAdvancedStatus ? (
                            <div>
                              ...
                              <p className="hideLikeAndViewDescriptionText">
                                이 게시물의 총 좋아요 및 조회수는 회원님만 볼 수
                                있습니다. 나중에 게시물 상단에 있는 ··· 메뉴에서
                                이 설정을 변경할 수 있습니다. 다른 사람의
                                게시물에서 좋아요 수를 숨기려면 계정 설정으로
                                이동하세요.{" "}
        ...
        {/* 하단 부분 */}
        <div className="newPosterBottomContainer"></div>
      </div>
